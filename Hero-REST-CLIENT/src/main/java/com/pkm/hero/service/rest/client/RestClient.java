...
public class RestClient {
	 ...
	 * @return
	 */
	protected String httpGetString(String url, String mediaType) throws HeroRestClientException {
		...
		try {
			...
			throw new HeroRestClientException(e);
		} finally {
			if (httpClient != null) {
				try {
					httpClient.close();
				} catch (IOException ioe) {
					throw new HeroRestClientException(ioe);
				}
			}
		}
	 ...
	 * @return
	 */
	protected String httpPostString(String url, String mediaType, String stringToPost) throws HeroRestClientException {
	 ...
	 * @return
	 */
	protected String httpPutString(String url, String mediaType, String stringToPut) throws HeroRestClientException {
	 ...
	 * @throws HeroRestClientException
	 */
	private void validateUrl(String url) throws HeroRestClientException {
		try {
			...
			throw new HeroRestClientException(new IllegalArgumentException(mue));
		}
	}

	/**
	 * Validate that the input response status code is a successful HTTP
	 * response, or throw an HeroRestClientException
	 * 
	 * @param httpOperation
	 * 
	 ...
	 * @throws HeroRestClientException
	 */
	private String parseAndValidateResponse(String httpOperation, HttpResponse response) throws HeroRestClientException {
		...
		if ((responseStatusCode < 200) || (responseStatusCode >= 400)) {
			...
			throw new HeroRestClientException("Failed : HTTP error code : " + responseStatusCode);
		} else {
